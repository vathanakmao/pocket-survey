...
public class OldOptionController {
    ...
    static final Logger LOG = LoggerFactory.getLogger(OldOptionController.class);
    ...
    public RedirectView create(
                        @RequestHeader(value=OldOptionController.NAME_X_REQUESTED_WITH, required=false) String xRequestedWith,
        ...
        if (OldOptionController.VALUE_X_REQUESTED_WITH_AJAX.equals(xRequestedWith) ||
                OldOptionController.EXPECTS_CREATED.equals(expects)) {

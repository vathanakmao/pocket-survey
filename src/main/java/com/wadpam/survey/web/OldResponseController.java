...
public class OldResponseController {
    ...
    static final Logger LOG = LoggerFactory.getLogger(OldResponseController.class);
    ...
    public RedirectView createFromForm(
                        @RequestHeader(value=OldResponseController.NAME_X_REQUESTED_WITH, required=false) String xRequestedWith,
        ...
        if (OldResponseController.VALUE_X_REQUESTED_WITH_AJAX.equals(xRequestedWith)) {

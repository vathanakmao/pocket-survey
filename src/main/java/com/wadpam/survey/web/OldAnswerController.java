...
public class OldAnswerController {
    ...
    static final Logger LOG = LoggerFactory.getLogger(OldAnswerController.class);
    ...
    public RedirectView create(
                                                @RequestHeader(value=OldAnswerController.NAME_X_REQUESTED_WITH, required=false) String xRequestedWith,
        ...
        if (OldAnswerController.VALUE_X_REQUESTED_WITH_AJAX.equals(xRequestedWith)) {

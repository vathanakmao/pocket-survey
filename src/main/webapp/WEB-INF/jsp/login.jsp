		...
		<div id="login_box">
			      ...
			      <form id="f" name="f" action="j_spring_security_check" method="POST">
						...
						<div class="input_fields">
							...
							<input  type ="email" id="j_username" name="j_username" autocapitalize="off" autocomplete="off" placeholder="<spring:message code="emailHint" />"  value="<%= null != lastUsername ? lastUsername : "" %>"/>
